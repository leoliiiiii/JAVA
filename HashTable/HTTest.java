...
public class HTTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        MyHashTable test2HT = new MyHashTable(11);
        System.out.println(test2HT.hashValue("a"));
        System.out.println(test2HT.hashValue("ag"));
        System.out.println(test2HT.hashValue("agg"));
        test2HT.insert("a");
        test2HT.display();
        test2HT.insert("ag");
        test2HT.display();
